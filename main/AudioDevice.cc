...
#define AUDIO_DEVICE_I2S_GPIO_BCLK 16
#define AUDIO_DEVICE_I2S_GPIO_WS 17
#define AUDIO_I2S_SPK_GPIO_EN GPIO_NUM_18
#define AUDIO_DEVICE_I2S_GPIO_DOUT 15
#define AUDIO_DEVICE_I2S_GPIO_DIN 2
#define AUDIO_DEVICE_I2S_SIMPLEX 1
#define AUDIO_DEVICE_I2S_MIC_GPIO_BCLK 40
#define AUDIO_DEVICE_I2S_MIC_GPIO_WS 42
...
void AudioDevice::Start(int input_sample_rate, int output_sample_rate)
{
...
#ifdef AUDIO_DEVICE_I2S_SIMPLEX
    ...
    xTaskCreate([](void *arg)
        ...
        audio_device->AudioPlayTask(); }, "audio_play", 4096 * 4, this, 5, &audio_play_task_);
}
...
void AudioDevice::CreateDuplexChannels()
{
    ...
    i2s_std_config_t std_cfg = {
        ...
        .slot_cfg = {.data_bit_width = I2S_DATA_BIT_WIDTH_32BIT, .slot_bit_width = I2S_SLOT_BIT_WIDTH_AUTO, .slot_mode = I2S_SLOT_MODE_MONO,
                     .slot_mask = I2S_STD_SLOT_LEFT, // wang
                     ...
                     .big_endian = false,
                     .bit_order_lsb = false},
        .gpio_cfg = {.mclk = I2S_GPIO_UNUSED, .bclk = (gpio_num_t)AUDIO_DEVICE_I2S_GPIO_BCLK, .ws = (gpio_num_t)AUDIO_DEVICE_I2S_GPIO_WS, .dout = (gpio_num_t)AUDIO_DEVICE_I2S_GPIO_DOUT, .din = (gpio_num_t)AUDIO_DEVICE_I2S_GPIO_DIN, .invert_flags = {.mclk_inv = false, .bclk_inv = false, .ws_inv = false}}};
...
void AudioDevice::CreateSimplexChannels()
{
    ...
    /* Set the GPIO level, 0 for low, 1 for high */
    ...
    i2s_std_config_t std_cfg = {
        ...
        .gpio_cfg = {.mclk = I2S_GPIO_UNUSED, .bclk = (gpio_num_t)AUDIO_DEVICE_I2S_GPIO_BCLK, .ws = (gpio_num_t)AUDIO_DEVICE_I2S_GPIO_WS, .dout = (gpio_num_t)AUDIO_DEVICE_I2S_GPIO_DOUT, .din = I2S_GPIO_UNUSED, .invert_flags = {.mclk_inv = false, .bclk_inv = false, .ws_inv = false}}};
    ESP_ERROR_CHECK(i2s_channel_init_std_mode(tx_handle_, &std_cfg));
    ...
    std_cfg.gpio_cfg.bclk = (gpio_num_t)AUDIO_DEVICE_I2S_MIC_GPIO_BCLK;
    std_cfg.gpio_cfg.ws = (gpio_num_t)AUDIO_DEVICE_I2S_MIC_GPIO_WS;
    std_cfg.gpio_cfg.dout = I2S_GPIO_UNUSED;
    std_cfg.gpio_cfg.din = (gpio_num_t)AUDIO_DEVICE_I2S_GPIO_DIN;
    ESP_ERROR_CHECK(i2s_channel_init_std_mode(rx_handle_, &std_cfg));
